...
public:
	...
	virtual vector<Employ> update(vector<Employ>* db, enumOptionList option, string searchValue, UpdateItem item) = 0;
protected:
...
class DatabaseUpdateByEmployeeNum : public DatabaseUpdate
{
public:
	vector<Employ> update(vector<Employ> * db, enumOptionList option, string searchValue, UpdateItem item) override
	{
		vector<Employ> employeeList;
		
		for (int i = 0; i < db->size(); i++) {
			Employ employee = (db->at(i));
			if (employee.getEmployeeNum() == stoi(searchValue)) {
				employeeList.push_back(employee);
				db->at(i) = updateItem(employee, item);
			}
		}
...
class DatabaseUpdateByName : public DatabaseUpdate
{
public:
	vector<Employ> update(vector<Employ>* db, enumOptionList option, string searchValue, UpdateItem item) override
	{
...
class DatabaseUpdateByCl : public DatabaseUpdate
{
public:
	vector<Employ> update(vector<Employ>* db, enumOptionList option, string searchValue, UpdateItem item) override
	{
...
class DatabaseUpdateByPhone : public DatabaseUpdate
{
public:
	vector<Employ> update(vector<Employ>* db, enumOptionList option, string searchValue, UpdateItem item) override
	{
...
class DatabaseUpdateByBirthday : public DatabaseUpdate
{
public:
	vector<Employ> update(vector<Employ>* db, enumOptionList option, string searchValue, UpdateItem item) override
	{
...
class DatabaseUpdateByCerti : public DatabaseUpdate
{
public:
	vector<Employ> update(vector<Employ>* db, enumOptionList option, string searchValue, UpdateItem item) override
	{
